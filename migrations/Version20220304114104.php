 ...
 */
final class Version20220304114104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE email (id INT NOT NULL, subject VARCHAR(255) DEFAULT NULL, text TEXT DEFAULT NULL, PRIMARY KEY(id))');
